        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form id="form1" name="form1" action="${path }/login.htm" method="post">
                    ...
                    <input type="text" class="form-control uname" placeholder="用户名" name="userName" id="userName" required="required" value="admin"/>
                    <input type="password" class="form-control pword m-b" placeholder="密码" id="password" name="password" required="required" value="admin"
						onkeydown="if(event.keyCode==13)form1.submit()" />
					<input type="text" class="form-control ucode" placeholder="验证码"
						required="required" value="admin" name="imageCode"
