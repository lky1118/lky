					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>状态：</td>
								<td><input type="radio" id="status" name="status" value="上架"
								 aria-required="true" required/>上架
								 <input type="radio" id="status" name="status" value="下架"
								 aria-required="true" required/>下架</td>
							</tr>
							<tr>
								<td>分类：</td>
								<td colspan="4">
