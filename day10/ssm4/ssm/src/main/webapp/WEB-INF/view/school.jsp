        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">分校名 </span>
			      <input type="text" name="schoolname" class="form-control" id="txt_search_schoolname" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">地址</span>
					<select class="form-control" name="areaid" id = "txt_search_areaid">
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            schoolname: $("#txt_search_schoolname").val(),
	            areaid: $("#txt_search_areaid").val(),
