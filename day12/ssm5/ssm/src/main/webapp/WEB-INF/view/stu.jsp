...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>性别：</td>
								<td><select class="form-control" name="sdsex" id = "sdsex" aria-required="true" required>
							...
							<tr>
								<td>爱好：</td>
								<td><input type="checkbox" id="sdhobby" name="sdhobby"
									value="足球" aria-required="true" required/>足球
									<input type="checkbox" id="sdhobby" name="sdhobby"
	...
	function initEditUser(getSelection){
		...
		var sdhobby = getSelection.sdhobby.split(",");
		for(var i=0; i<sdhobby.length; i++){
			$("input[type='checkbox'][value='"+sdhobby[i]+"']").prop("checked",true);
		}
