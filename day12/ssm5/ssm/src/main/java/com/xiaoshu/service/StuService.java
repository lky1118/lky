...
public class StuService {
	...
	// 通过用户名判断是否存在，（新增时不能重名）
	public Stu existUserWithUserName(String sdname) throws Exception {
	...
	public List<Svo> findAll(Svo svo) {
		// TODO Auto-generated method stub
		return stuMapper.selectStu(svo);
	}

	
	public List<Svo> find(Svo s) {
		// TODO Auto-generated method stub
		return stuMapper.fingpage(s);
	}
