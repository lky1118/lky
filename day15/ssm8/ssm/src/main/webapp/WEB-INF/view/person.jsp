					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>爱好：</td>
								<td><input type="checkbox" id="pLike" name="pLike" value="篮球"
								 aria-required="true" required/>篮球
								 <input type="checkbox" id="pLike" name="pLike" value="足球"
								 aria-required="true" required/>足球
								 <input type="checkbox" id="pLike" name="pLike" value="排球"
...
<!-- Echarts对话框-->
	...
	function initEditUser(getSelection){
		...
		//多选框回显
		var hobby = getSelection.pLike.split(",");
		for(var i=0; i<hobby.length; i++){
		$("input[type='checkbox'][value='"+hobby[i]+"']").prop("checked",true);
		  }
	}
			    	    ...
			    	    series : [
			    	        {
			    	            ...
			    	            center: ['50%', '60%'],
			    	            data:[
			    	                {value:res.zg, name:'北京'},
			    	                {value:res.jt, name:'上海'},
			    	                {value:res.gs, name:'武汉'}
			    	            ],
			    	            itemStyle: {
			    	                emphasis: {
			    	                    shadowBlur: 10,
