...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_start" name="start" class="laydate-icon form-control layer-date" readonly="readonly"/>
                     <input placeholder="结束时间"id="txt_search_end" name="end" class="laydate-icon form-control layer-date" readonly="readonly"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>所属年纪：</td>
								<td><select class="form-control" name="grade" id = "grade">
										<option value="">---请选择---</option>
										<option value="一年级">一年级</option>
										<option value="二年级">二年级</option>
										<option value="三年级">三年级</option>
							...
							<tr>
								...
								<td>入校时间</td>
								<td>
									<input type="date" id="entrytime" name="entrytime" readonly="readonly"
	...
	<div class="modal fade" id="modal_user_addCourse" role="dialog" aria-labelledby="modal_user_addCourse" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addCourse" method="post" action="reserveCourse.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名称：</td>
								<td><input type="text" id="name" name="name"
	...
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="width: 400px;height: 400px" id="main">
    			...
    			$.ajax({
    			    ...
    			    success:function(res){
    			    	...
    			    	for (var i = 0; i < obj.length; i++) {
    			    		xdate[i]={value:obj[i].num,name:obj[i].cname};
						}
