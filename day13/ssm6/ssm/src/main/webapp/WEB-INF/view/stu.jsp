					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<input type="radio" id="sSex" name="sSex" value="女" aria-required="true" required/>女
								</td>
							</tr>
							<tr>
								<td>爱好：</td>
								<td><input type="checkbox" id="sHobby" name="sHobby" value="篮球" aria-required="true" required/>篮球
								<input type="checkbox" id="sHobby" name="sHobby" value="足球" aria-required="true" required/>足球
								<input type="checkbox" id="sHobby" name="sHobby" value="排球" aria-required="true" required/>排球</td>
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
...
<!-- Echarts对话框-->
	...
	function initEditUser(getSelection){
		...
		var sHobby = getSelection.sHobby.split(",");
		for(var i=0; i<sHobby.length; i++){
			$("input[type='checkbox'][value='"+sHobby[i]+"']").prop("checked",true);
		}
