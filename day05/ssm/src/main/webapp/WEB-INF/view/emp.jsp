					...
					<form id="form_user" method="post" action="reserveEmp.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>
									<img alt=""  id="pics" src="">
									<input type="file" id="piFile" name="piFile">
									<input type="hidden" id="pic">
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>爱好：</td>
								<td>
							篮球	<input type="checkbox" id="hobby1" name="hobby" value="篮球"
									 aria-required="true" required/>
								足球	<input type="checkbox" id="hobby2" name="hobby"  value="足球"
									 aria-required="true" required/>
									排球<input type="checkbox" id="hobby3" name="hobby" value="排球"
									 aria-required="true" required/>
