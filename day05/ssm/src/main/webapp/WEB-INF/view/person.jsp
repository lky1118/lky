        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="gId" id = "txt_search_roleid">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td><input type="radio" id="gender" name="gender" value="男"
									 aria-required="true" required/>男</td>
									<td><input type="radio" id="gender" name="gender" value="女"
							...
							<tr>
								<td>入职日期：</td>
								<td><input type="date" id="time" name="time"
									class="form-control" aria-required="true" required/></td>
							</tr>
